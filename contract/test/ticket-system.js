...
describe("TicketSystem", function () {
  ...
  xit("Can't send if payment amount differ from price", async function () {
  ...
  xit("Can send if is not the owner", async function () {
    const SendEther = await ethers.getContractFactory("SendEther");
    const send_ether = await SendEther.deploy();
    await send_ether.deployed();
  ...
  xit("Can withdraw if is the owner", async function () {
    const SendEther = await ethers.getContractFactory("SendEther");
    const send_ether = await SendEther.deploy();
    await send_ether.deployed();
  ...
  xit("Can't withdraw if payment amount differ from price", async function () {
    const SendEther = await ethers.getContractFactory("SendEther");
    const send_ether = await SendEther.deploy();
    await send_ether.deployed();
